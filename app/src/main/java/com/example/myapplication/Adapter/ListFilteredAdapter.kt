...
class ListFilteredAdapter(val items: List<ItemsModel>):
RecyclerView.Adapter<ListFilteredAdapter.Viewholder>()
{
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ListFilteredAdapter.Viewholder {
        val binding= ViewholderPopularBinding.inflate(LayoutInflater.from(parent.context),parent,false)
        return Viewholder(binding)
    }

    override fun onBindViewHolder(holder: ListFilteredAdapter.Viewholder, position: Int) {
